  ...
  <body class="layout layout-header-fixed layout-left-sidebar-fixed">
    ...
    <div class="site-main">
      ...
      <div class="site-content">
        <div class="row">
          <div class="col-sm-6">
            <div class="widget-infoblock wi-large m-b-30" style="background-image: url(<%=request.getContextPath()%>/adminResources/images/1.jpg)">
          ...
          <div class="col-sm-6">
            <div class="row">
              <div class="col-sm-6">
                <div class="widget-infoblock wi-small m-b-30" style="background-image: url(<%=request.getContextPath()%>/adminResources/images/2.jpg)">
                  <div class="wi-bg"></div>
                  <div class="wi-content-bottom p-a-30">
              ...
              <div class="col-sm-6">
                <div class="widget-infoblock wi-small m-b-30">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="widget-infoblock wi-small m-b-30" style="background-image: url(<%=request.getContextPath()%>/adminResources/images/3.jpg)">
                  <div class="wi-bg"></div>
                  <div class="wi-content-bottom p-a-30">
