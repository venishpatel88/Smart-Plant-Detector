  ...
  <body class="authentication-body">
    <div class="container-fluid">
      <div class="authentication-header m-b-30">
        <div class="clearfix">
          ...
          <div class="pull-right">
            <a href="/pages-signup.html" class="btn btn-outline-info">Sign up</a>
          </div>
        </div>
      </div>
      <div class="row">
          ...
          <div class="authentication-content m-b-30">
            ...
            <form action="j_spring_security_check" method="post" role="form">
              <div class="form-group">
                <label for="form-control-1">Email address or username</label>
                <input type="text" class="form-control" id="inputUsernameEmail" name="username" placeholder="Email">
              </div>
              <div class="form-group">
      ...
      <div class="authentication-footer">
        <span class="text-muted">New User? Create your account by clicking<a href="register">here!</a></span><br>
